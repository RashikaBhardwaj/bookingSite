          ...
          <table className="min-w-full table-fixed border-collapse border border-gray-200">
            ...
            <tbody>
              ...
              <tr className="hover:bg-gray-100">
                ...
                <td className="py-3 px-1 border-b border-gray-200">{item.hotelphone}</td>
                ...
                <td className="py-3 px-1 border-b border-gray-200">
                  <button className="rounded-md bg-red-700 text-white size-12" onClick={()=>handelDelete(item._id)}>
                    Delete
                  </button>
                </td>
              </tr>
